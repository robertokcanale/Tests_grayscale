...
#MODEL IMPORT
saved_model_dir_trt = 'Models/HandsNet_2_trt16'
...
for i in range(iterations):
        ...
        image_hand = tf.keras.preprocessing.image.load_img(im_name, target_size = (100, 68), color_mode="grayscale")
        time_i = time.time()
...
np.savetxt("test_HN2_16.txt", elapsed)
...
plt.xlabel("Image")
plt.ylabel("Seconds")
plt.title('HN2 fp16 Processing Time /per Image')
